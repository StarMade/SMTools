 ...
 public class Matrix4i implements java.io.Serializable, Cloneable {
   ...
   */  
   ...
   /**
    ...
    /**
     * Sets the value of this matrix to the int value of the
     * passed matrix4d m1.
   ...
   public final void invert()
  {
     ...
     * matrix values in the single precision Matrix3i argument; the other
    ...
    {
       m00 = m1.m00; m01 = m1.m01; m02 = m1.m02; m03 = 0;
       m10 = m1.m10; m11 = m1.m11; m12 = m1.m12; m13 = 0;
       m20 = m1.m20; m21 = m1.m21; m22 = m1.m22; m23 = 0;
    ...
    {
       m00 = (int)m1.m00; m01 = (int)m1.m01; m02 = (int)m1.m02; m03 = 0;
       m10 = (int)m1.m10; m11 = (int)m1.m11; m12 = (int)m1.m12; m13 = 0;
       m20 = (int)m1.m20; m21 = (int)m1.m21; m22 = (int)m1.m22; m23 = 0;
       m30 = 0;   m31 = 0  ; m32 = 0  ; m33 = 1;
    }
   ...
   /**
     ...
     * of the Point3i argument; the other values of this matrix are not
     * modified.
   ...
   * @param pointOut  the transformed point
     public final void transform(Point3i point, Point3i pointOut)
    {
        int x,y;
   ...
   * point input paramter is assumed to be one.
   * @param point  the input point to be transformed.
     public final void transform(Point3i point)
    {
        int  x, y;
        x = m00*point.x + m01*point.y + m02*point.z + m03;
        y = m10*point.x + m11*point.y + m12*point.z + m13;
